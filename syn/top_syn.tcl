...
# Analyze Design
analyze -format sverilog {rtl/define.v rtl/top.v rtl/mm_ctrl.v rtl/buffer.v rtl/mac.v rtl/vec_product.v rtl/ppu.v rtl/quantize.v rtl/softmax.v rtl/reciprocal.v}
elaborate $DESIGN
