...
# create clock
create_clock -name "clk" -period 50 -waveform {"0" "25"} {"i_clk"}
...
# report
report_timing -path full -delay max -max_paths 1 -nworst 1 > syn/${DESIGN}/${DESIGN}.timing
report_area -nosplit > syn/${DESIGN}/${DESIGN}.area

# write files
write_sdf -version 2.1 syn/${DESIGN}/${DESIGN}_syn.sdf
write -format verilog -hierarchy -output syn/${DESIGN}/${DESIGN}_syn.v
