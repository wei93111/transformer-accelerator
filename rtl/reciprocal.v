module reciprocal (
    ...
    reg  [17:0] data_norm_pl0_w, data_norm_pl0_r;   // Q0.18 (interperet as)
    reg  [17:0] y0_pl0_w,        y0_pl0_r;          // Q1.17
    reg  [17:0] y0_pl1_w,        y0_pl1_r;
    reg  [17:0] y0_pl2_w,        y0_pl2_r;
    reg  [4:0]  lzc_pl0_w,       lzc_pl0_r;
    reg  [4:0]  lzc_pl1_w,       lzc_pl1_r;
    reg  [4:0]  lzc_pl2_w,       lzc_pl2_r;

    // newton iteration
    reg  [35:0] mult;                               // Q1.35
    reg  [35:0] mult2;                              // Q2.34
    
    reg  [17:0] mult1_w,         mult1_r;           // Q1.17
    reg  [17:0] sub_w,           sub_r;             // Q1.17
    reg  [35:0] recip_w,         recip_r;           // Q2.34


    assign o_recip = recip_r;
    ...
    always @(*) begin
        ...
        data_norm       = i_data << lzc;
        y0_pl0_w        = recip_lut(data_norm[17:8]);    // Q1.17, take top 10 bits as lut index
        lzc_pl0_w       = lzc;
        data_norm_pl0_w = data_norm;

        // stage 1
        mult      = data_norm_pl0_r * y0_pl0_r;
        mult1_w   = mult >> 18;
        y0_pl1_w  = y0_pl0_r;
        lzc_pl1_w = lzc_pl0_r;

        // stage 2
        sub_w     = TWO - {1'b0, mult1_r};
        y0_pl2_w  = y0_pl1_r;
        lzc_pl2_w = lzc_pl1_r;

        // stage 3
        mult2   = y0_pl2_r * sub_r;
        recip_w = mult2 >> (5'd18 - lzc_pl2_r);
    end
    ...
    always @(posedge i_clk or negedge i_rst_n) begin
        if (!i_rst_n) begin
            ...
            data_norm_pl0_r <= data_norm_pl0_w;
            y0_pl0_r        <= y0_pl0_w;
            y0_pl1_r        <= y0_pl1_w;
            y0_pl2_r        <= y0_pl2_w;
            lzc_pl0_r       <= lzc_pl0_w;
